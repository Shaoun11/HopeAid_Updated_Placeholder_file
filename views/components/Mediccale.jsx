...
import mediacle_Image from '../../public/Medicale_Image/530x600.svg';
const MedicalPage = () => {
    const [series] = useState([
        {
            name: "Hospital Donations",
             data: [2000, 2100, 2200, 2300, 4800, 2500, 2600, 2700, 2800, 2900, 3000, 3100],
        },
        {
            name: "Medical Supplies",
            data: [2500, 2600, 2800, 2900, 3100, 3200, 3400, 3500, 3600, 3700, 3800, 3900],
        },
        {
            name: "Total Donation",
            data: [4500, 4700, 5000, 5200, 5500, 5700, 6000, 6200, 6400, 6600, 6800, 7000], // Adjusted example data for Total Donation
        }
    ]);
    ...
    const [options] = useState({
        ...
        colors: ['#1E90FF', '#4ea69e', '#66ba69'], // Colors for Hospital Donations, Medical Supplies, and Total Donation
        dataLabels: {
            enabled: false
        },
        stroke: {
                    ...
                    <div className="flex flex-col items-center justify-between lg:flex-row">
                        <div className="">
                            <div className="lg:max-w-xl lg:pr-5">
                                ...
                                <p className="text-base text-gray-700">Your donations provide humanitarian aid and medical support, creating lasting impacts on the lives of those in need.</p>
                            </div>
                            ...
                            <div className="mt-12 flex flex-col space-y-3 divide-gray-300 text-sm text-gray-700 sm:flex-row sm:space-y-0 sm:divide-x">
                                ...
                                <div className="flex max-w-xs space-x-2 px-4">
                                    ...
                                    <p> Support humanity and Change lives.</p>
                                </div>
                            </div>
                        </div>
                        <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
                            ...
                            <div className="w-fit rounded-[6rem] mx-auto overflow-hidden rounded-tl-none rounded-br-none ">
                                ...
                                <img className="-mb-20 w-[530px] h-[600px] object-cover" src={mediacle_Image} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="mt-8 flex-col items-end space-y-3 rounded-xl px-4 py-4 sm:w-1/3 md:ml-auto lg:flex">
                        <div className="bg flex w-full flex-col items-center justify-center rounded-xl bg-[#30978E] px-2 py-2 text-white shadow-lg sm:h-56 sm:w-56">
                            ...
                            <div className="text-center">
                                <p className="text-4xl font-bold">7820</p>
                        ...
                        <div className="bg flex w-full flex-col items-center justify-center rounded-xl bg-[#30978E] px-2 py-2 text-white shadow-lg sm:h-56 sm:w-56">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm">Medical Supplies</p>
                            </div>
                        </div>
                        <div className="bg flex w-full flex-col items-center justify-center rounded-xl bg-[#30978E] px-2 py-2 text-white shadow-lg sm:h-56 sm:w-56">
                            <div className="p-3">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm"> Hospital Donations</p>
                            </div>
                        </div>
                    </div>
                </div>
